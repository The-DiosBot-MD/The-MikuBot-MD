...
echo -e "\033[01;33mpkg install git -y\npkg install nodejs -y\npkg install ffmpeg -y\npkg install imagemagick -y\npkg install -y yarn\ngit clone https://github.com/The-DiosBot-MD/The-MikuBot-MD\ncd The-MikuBot-MD\nyarn install\nnpm install\nnpm start\033[0m"
exit 1
else
...
echo -e "\033[1;35m"
git clone https://github.com/The-DiosBot-MD/The-MikuBot-MD && cd The-MikuBot-MD
...
menu_ayuda() {
	...
	case $opcion in
            01|1)
                am start -a android.intent.action.VIEW https://chat.whatsapp.com/C92isvspFcXCtqv2PqCfHI &>> /dev/null
...
echo -e "\033[01;32m\033[01mIniciando The-MikuBot!\n\033[0m"
npm start
