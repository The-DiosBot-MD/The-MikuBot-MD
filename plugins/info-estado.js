...
const handler = async (m, { conn, usedPrefix }) => {
  ...
  const wm = 'The-MikuBot-MD';
  const info = ` ${tradutor.texto1[0]}

  ${tradutor.texto1[1]} AdrianOficial
  ${tradutor.texto1[2]} +595976126756
  ${tradutor.texto1[3]} ig adri.analegresanchez
  ...
  const Message = {
    ...
    contextInfo: {
      ...
      externalAdReply: {
        ...
        thumbnail: imagen1,
        sourceUrl: "https://github.com/The-DiosBot-MD/The-MikuBot-MD",
      },
    },
    caption: info,
    footer: wm,
